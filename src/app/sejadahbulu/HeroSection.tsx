      ...
      >
        ...
        >
          <div className="relative group">
            ...
            <Image src="/img/B1.JPG" alt="gambar" width={280} height={250} />
          </div>
          ...
          <div className="relative group">
            ...
            <Image src="/img/bs3.jpeg" alt="gambar" width={280} height={250} />
          </div>
          <div className="relative group">
            <div className="absolute inset-0 hidden group-hover:flex bg-black/75 items-center justify-center">
              <Link href="/sbulu3">
            ...
            <Image src="/img/B6.jpg" alt="gambar" width={280} height={250} />
          </div>
          <div className="relative group">
            <div className="absolute inset-0 hidden group-hover:flex bg-black/75 items-center justify-center">
              <Link href="/sbulu4">
            ...
            <Image src="/img/B7.JPG" alt="gambar" width={280} height={250} />
          </div>
        </div>
        <br />
      </div>
